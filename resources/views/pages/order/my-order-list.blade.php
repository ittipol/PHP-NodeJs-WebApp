	      ...
	      <div class="cart-card-item-right fl w-100">
	        <div class="cart-card-item-inner cart-card-item-borderless clearfix">
	          ...
	          <div class="item-content fl">
	            <div class="item-primary-text"><a href="/order-detail/{{ $value['id'] }}">คำสั่งซื้อที่ {{ $value['id'] }}</a> ({{ $value['orderStatusLabel'] }})</div>
...
<div class="c-list-container mv7">
  <div class="message-panel tc">
    <div class="center w-90 w-100-ns">
      <h5>ไม่พบรายการสั่งซื้อสินค้าของฉันที่ตรงกับการค้นหา</h5>
    </div>
  </div>
</div>
...
<div class="c-list-container mv7">
  <div class="message-panel tc">
    <div class="center w-90 w-100-ns">
      <h5>ยังไม่มีรายการสั่งซื้อสินค้าของฉัน</h5>
    </div>
  </div>
</div>
