...
<div class="c-form-container mt4">
  <h4 class="mb5">
    <a href="/ticket/view/{{$data['id']}}" class="c-btn mr3"><i class="fa fa-chevron-left"></i></a> แก้ไขรายการขาย
  </h4>
</div>

{{Form::model($data, ['id' => 'item_form', 'method' => 'PATCH', 'enctype' => 'multipart/form-data'])}}
      ...
      <div class="col-12">
        ...
        <div class="form-group">
          ...
          <div id="selecting_location" class="c-modal">
            ...
            <input type="hidden" name="ItemToLocation[location_id]" value="{{$locationId}}">
          </div>
  ...
  <div class="c-form-container mb4">
    ...
    <div id="date_group_1" class="row">
      ...
      <div class="form-group col-md-6">
        ...
        <div class="input-group">
          {{ Form::select('start_time_hour', $hour, null, array('class' => 'form-control')) }}
          {{ Form::select('start_time_min', $min, null, array('class' => 'form-control')) }}
        </div>
      </div>
    </div>
      ...
      <div class="col-12">
        ...
        <div class="mb5">
          ...
          <div id="banner" class="banner">
            ...
            @else
              <div class="data-banner-delete-btn pointer db" data-filename="1">
            @endif
              <span aria-hidden="true">&times;</span>
            </div>

            <div class="data-banner-wrapper">
              <img class="r-data-banner data-banner" @if(!empty($banner)) src="/get_image/{{$banner}}" @endif>
        ...
        <div class="form-group mb5">
          <label class="form-control-label">รูปภาพ Preview</label>

          <div class="alert alert-secondary" role="alert">
            เลือกรูปภาพที่ต้องการให้แสดงเป็นรูปภาพ Preview <a href="#" data-toggle="modal" data-c-modal-target="#model_item_preview">สิ่งนี้คือ?</a>
          </div>
          ...
          <div class="c-card c-card--to-edge center">
            <div class="c-card--inner overflow-visible">
              ...
              <div id="preview" class="preview">
                ...
                @else
                  <div class="data-preview-delete-btn pointer db" data-filename="1">
                @endif
                  <span aria-hidden="true">&times;</span>
                </div>

                <div class="data-preview-wrapper">
                  <img class="r-data-preview data-preview" @if(!empty($preview)) src="/get_image/{{$preview}}" @endif>
                ...
                <input type="hidden" name="Preview[filename]" @if(!empty($preview)) value="{{$preview}}" @endif>
              </div>
        ...
        <div class="form-group">
          ...
          <div class="alert alert-secondary mb0 br0">
            <ul class="ma0">
  ...
  {{Form::submit('บันทึก', array('class' => 'c-floating-btn form-floating-btn btn-hide-bottom btn-hide-when-input white'))}}
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    // categoryList.init();
    // categoryList.setDataId({{$categoryId}});
    // categoryList.setDataPath({!!$categoryPaths!!});
    // categoryList.setSelectedLabel();
