      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <div class="pv2 pv3-ns">
            <h4 class="mt1 white">
              <div class="avatar-frame dib">       
                <div class="avatar">
                  <img class="frame-border" src="{{$user['avatar']}}">
                </div>
                <div class="online_status_indicator_{{$user['id']}} online-status-indicator fixed-top-left @if($user['online']) is-online @endif"></div>
              </div>
              รายการขายของ {{$user['name']}}
            </h4>
          </div>
        </div>
...
@else
  ...
  <div class="c-page-container page-wrapper page-item-style">
    ...
    <div class="pv3 pv4-ns mt0 mt4-ns mb5 mh0-ns bg-blue br0 br2-ns w-50-ns center">
      <div class="c-main-container">
        <div class="alert ma0 pv0 white tc">
          <p class="ma0">รายการขายของผู้ขายรายนี้จะแสดงอยู่บนร้านขายสินค้า</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="tc">
    <a href="/shop/page/{{$shop['slug']}}/item" class="btn c-btn c-btn-bg c-shadow-2">
      <i class="fas fa-hotel"></i> ไปยัง "{{$shop['name']}}"
    </a>
  </div>
@endif
