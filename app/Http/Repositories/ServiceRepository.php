...
class ServiceRepository
{
  ...
  public function addUserLog($modelName,$modelId,$action,$relatedWith = [],$userId = null) {
  ...
  public function facebookGetUserProfile($accessToken) {
  ...
  public function facebookReScrap($url = null, $absPath = false){
  ...
  public function getSummaryTitle($alias) {
  ...
  public function getSummaryClass($alias) {
  ...
  public function pdfUrlExists($url = null){
